...
describe "UA_iOS_Migration" do
  it "should perform migrations of iOS device tokens from Urban Airship to our system" do
    UA_iOS_Migration.new.method_defined?(:perform)
  end
end
